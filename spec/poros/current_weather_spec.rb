...
RSpec.describe CurrentWeather do
  before do
    @current_weather = WeatherFacade.get_weather('39.738453', '-104.984853')
  end
  ...
  it 'has attributes', :vcr do
    ...
    expect(@current_weather.sunrise).to eq('2022-01-17 07:18:14 -0700')
    expect(@current_weather.sunset).to eq('2022-01-17 17:01:30 -0700')
